...
time_0_time_end_stack_aov$Species <- sub("Ncor[0-9]", "Ncor", time_0_time_end_stack_aov$Species, perl=TRUE)
time_0_time_end_stack_aov$Species <- sub("Cwil[0-9]", "Cwil", time_0_time_end_stack_aov$Species, perl=TRUE)
time_0_time_end_stack_aov$Species <- sub("Lsquam[0-9]", "Lsquam", time_0_time_end_stack_aov$Species, perl=TRUE)
time_0_time_end_stack_aov$Species <- sub("Than[0-9]", "Than", time_0_time_end_stack_aov$Species, perl=TRUE)
...
levels(time_0_time_end_stack_aov$Species) <- c("C.wilsoni","L.squamifrons", "N.coriiceps", "T.hansoni")
